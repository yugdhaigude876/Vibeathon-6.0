    ...
    <div className="flex min-h-screen items-center justify-center bg-background px-4 py-8 sm:px-6">
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          ...
          <CardTitle className="text-2xl font-bold tracking-tight">Create PLATR Account</CardTitle>
          <CardDescription>Join as a customer to browse menus, reserve tables & order online</CardDescription>
        </CardHeader>
        <CardContent>
          <div className="flex flex-col gap-4">
            <Button
              type="button"
              variant="outline"
              className="w-full h-11 flex items-center justify-center gap-2 border-slate-300 font-medium hover:bg-slate-50 dark:hover:bg-slate-900"
              disabled={loading}
            ...
            <p className="text-center text-xs text-muted-foreground border-t pt-3">
              Are you restaurant staff or management?{' '}
              <Link href="/login" className="font-medium text-primary underline-offset-4 hover:underline">
